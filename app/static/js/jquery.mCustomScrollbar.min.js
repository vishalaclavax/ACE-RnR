			...
			I = function () {
				...
				m
					...
					e(document)
						...
						.add(p)
						.bind("mouseup." + u + " touchend." + u + " pointerup." + u + " MSPointerUp." + u, function (e) {
				...
				r.bind("focusin." + i, function (o) {
					...
					a.is(n.advanced.autoScrollOnFocus) &&
						...
						(t[0]._focusTimeout = setTimeout(function () {
							...
							"x" === n.axis || i[0] || G(t, e[0].toString(), { dir: "y", scrollEasing: "mcsEaseInOut", overwrite: c, dur: s }), "y" === n.axis || i[1] || G(t, e[1].toString(), { dir: "x", scrollEasing: "mcsEaseInOut", overwrite: c, dur: s });
						}, t[0]._focusTimer)));
				});
			},
			U = function () {
