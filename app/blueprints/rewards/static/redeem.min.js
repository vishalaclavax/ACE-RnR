$(document).ready(function() {
    ...
    $(document).on('click', '.rewardprice li', function() {
        ...
        try{
            ...
            var voucher_value1 = voucher_value * voucher_qty;
    ...
    $.ajax({
        ...
        success: function (data, status, xhr) {
            ...
            if (data.success) {
                ...
                // $("#orderplaced").show();
                if(data.cardData.voucher_code==null || data.cardData.voucher_code=="null")
                {
                    $("#voucherCode").addClass('hide');
                }else{
                    $("#voucherCode").text('Voucher Code :'+ data.cardData.voucher_code);
                    $("#voucher_image_placed").attr("src", data.cardData.image);
                    $("#voucherCode").removeClass('hide');
                }                    
                $("#pin").text('PIN :'+data.cardData.pin);
                $("#voucher_image").attr("src", data.cardData.image);
                $("#email").text(data.cardData.email);
                $("#giftCard").text(data.cardData.VoucherName);
                // $("#secondSection").hide();
                ...
                // $("#claimYourVoucherModal").modal('hide');
                // alert(data.message);
